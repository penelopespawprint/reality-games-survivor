...
import { getTimeline, getDashboardStats, getRecentActivity, getSystemHealth, getDraftStats, getPaymentStats, getTriviaStats, getLeagueBreakdown, getNotificationStats, } from '../../services/admin-dashboard.js';
const router = Router();
...
router.get('/trivia-stats', async (req, res) => {
    try {
...
router.get('/league-breakdown', async (req, res) => {
    try {
...
router.get('/all', async (req, res) => {
    try {
        const [timeline, stats, activity, health, draftStats, paymentStats, triviaStats, leagueBreakdown, notificationStats,] = await Promise.all([
            getTimeline(),
            getDashboardStats(),
