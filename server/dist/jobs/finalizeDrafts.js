...
export async function finalizeDrafts() {
    ...
    for (const league of leagues) {
        ...
        for (const need of usersNeedingPicks) {
            if (castawayIndex >= shuffled.length)
                break;
            const castaway = shuffled[castawayIndex++];
            const pickNumber = need.round === 1
...
//# sourceMappingURL=finalizeDrafts.js.map