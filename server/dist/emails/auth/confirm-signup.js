// Confirm Sign Up Email Template for Supabase
// Copy this HTML into Supabase Dashboard > Authentication > Email Templates > Confirm sign up
...
`;
export const confirmSignupSubject = 'Confirm your email - Reality Games: Survivor';
