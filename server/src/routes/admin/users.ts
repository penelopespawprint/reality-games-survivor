...
router.patch('/:id', async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    if (favorite_castaway !== undefined) updates.favorite_castaway = favorite_castaway;
...
router.post('/:id/impersonate', async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.params.id;
...
router.get('/segments/stats', async (req: AuthenticatedRequest, res: Response) => {
  try {
    // Get all users
