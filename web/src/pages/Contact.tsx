...
export default function Contact() {
  ...
  const reasonOptions = [
    { value: 'general', label: 'General Inquiry', icon: HelpCircle, description: 'General questions about RGFL' },
    { value: 'support', label: 'Support', icon: MessageSquare, description: 'Need help with your account or leagues' },
    { value: 'bug', label: 'Report a Bug', icon: Bug, description: 'Something not working right?' },
    { value: 'feature', label: 'Feature Request', icon: Lightbulb, description: 'Have an idea to make RGFL better?' },
    { value: 'other', label: 'Other', icon: AlertCircle, description: 'Anything else on your mind' },
  ];
        ...
        <div className="mt-6 bg-white rounded-2xl shadow-card p-5 border border-cream-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-neutral-500 text-sm">
                We typically respond within 24-48 hours. For urgent matters during the season,
                we'll do our best to get back to you even faster!
              </p>
            </div>
          </div>
        </div>
