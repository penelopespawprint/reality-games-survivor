    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <div className="bg-white rounded-2xl shadow-card p-4 border border-cream-200">
          ...
          <p className="text-2xl font-bold text-neutral-800">{memberCount}/{league?.max_players}</p>
        </div>
        <div className={`rounded-2xl p-4 border ${
          ...
          <p className={`text-2xl font-bold ${spotsRemaining > 0 ? 'text-green-600' : 'text-red-600'}`}>
            {spotsRemaining}
          </p>
        </div>
      </div>
        ...
        <div className="divide-y divide-cream-100">
          ...
          {league?.require_donation && (
            <div className="px-4 py-3 flex items-center justify-between">
              ...
              <span className="text-burgundy-500 font-bold">
