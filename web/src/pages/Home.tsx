 ...
 *
 * Fantasy Survivor landing with Season 50 signup CTAs.
 */
    ...
    >
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full">
        <div className="text-center">
          ...
          <h1 className="text-6xl sm:text-7xl md:text-8xl text-gray-900 leading-[0.95] mb-10" style={{ fontFamily: 'Georgia, Times New Roman, serif', fontWeight: 400 }}>
            Fantasy Survivor<br />
            for People Who<br />
          ...
          <p className="text-xl sm:text-2xl text-gray-600 mb-12 leading-relaxed max-w-2xl mx-auto">
            100+ scoring rules. Real strategy. No luck required.<br />
