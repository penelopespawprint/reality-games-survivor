  ...
  public: {
    Tables: {
      admin_audit_log: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["admin_id"]
            isOneToOne: false
            referencedRelation: "v_conversion_candidates"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      conversation_stats: {
        ...
        Relationships: [
          {
            foreignKeyName: "conversation_stats_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
      ...
      relationship_health: {
        Row: {
          ...
          id: string
          initiation_balance: number | null
          tier: string | null
          user_id: string
        }
        Insert: {
      ...
      user_settings: {
        Row: {
          ...
          ghost_risk_enabled: boolean | null
          ghost_risk_threshold: number | null
          ghost_risk_tier_override: Json | null
          id: string
      ...
      users: {
        Row: {
          ...
          ai_conversations_used: number | null
          avatar_url: string | null
          billing_interval: string | null
          bio: string | null
          contact_limit: number | null
          contacts_locked: boolean | null
          created_at: string | null
    ...
    Functions: {
      ...
      cancel_user_subscription: {
        Args: { p_immediately?: boolean; p_user_id: string }
        Returns: boolean
      }
      ...
      reset_ai_conversations: { Args: never; Returns: number }
      submit_draft_pick: {
        Args: {
