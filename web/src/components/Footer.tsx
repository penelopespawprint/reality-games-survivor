        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/how-to-play" className="text-neutral-300 hover:text-burgundy-400 transition-colors text-sm">
                  How to Play
                </Link>
              </li>
              <li>
                <Link to="/how-to-play#scoring" className="text-neutral-300 hover:text-burgundy-400 transition-colors text-sm">
                  Scoring Rules
                </Link>
              </li>
              <li>
                <Link to="/castaways" className="text-neutral-300 hover:text-burgundy-400 transition-colors text-sm">
                  Castaways
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/sms" className="text-neutral-300 hover:text-burgundy-400 transition-colors text-sm">
                  SMS Commands
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-neutral-300 hover:text-burgundy-400 transition-colors text-sm">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-neutral-300 hover:text-burgundy-400 transition-colors text-sm">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-neutral-300 hover:text-burgundy-400 transition-colors text-sm">
                  Terms of Service
                </Link>
              </li>
            </ul>
